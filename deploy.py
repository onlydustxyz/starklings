...
assert len(repo.index.entries) == 0, "There are uncommited changes, aborting."
...
# create branch
release_branch = repo.create_head(f"release/{new_starklings_version}")
...
print("You can now create a pull request with this release branch.")
